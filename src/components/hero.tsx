  ...
  return (
    <section className="relative h-screen flex flex-col justify-between overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <video 
          src="https://framerusercontent.com/assets/Iycx9u2R769lOoLLgJ6dU9rG4.webm" 
          autoPlay 
          loop 
          muted 
          playsInline 
      ...
      <div className="relative z-10 flex-1 px-8 md:px-20 pt-32 md:pt-48">
        ...
        >
          <h1 className="font-mango text-[18vw] leading-[0.8] tracking-tighter text-brand-beige flex items-baseline">
            {text}
            <span className="w-[1.5vw] h-[10vw] bg-brand-beige inline-block ml-2 animate-pulse" />
          </h1>
        </motion.div>
      </div>
