        ...
        {item.href && active && (
          <div className="mt-4 pointer-events-auto">
             <a 
               ...
               target="_blank" 
               rel="noreferrer" 
               className="inline-flex items-center gap-2 px-4 py-2 bg-brand-red text-white text-sm font-bold uppercase tracking-wider rounded-full hover:bg-red-700 transition"
             >
               Watch Video <SquareArrowOutUpRight className="w-4 h-4" />
             </a>
          </div>
        )}
      </div>
